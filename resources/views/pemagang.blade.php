  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets/img/areakerja.png" alt="">
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li class="dropdown"><a href="#"><span>Tersedia</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{url('/catering')}}">Catering</a></li>
              <li><a href="{{url('/kostkostn')}}">Kost-kostn</a></li>
              <li><a href="{{url('/penyewaanmotor')}}">Penyewaan motor</a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="#counts">Divisi</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box" data-aos="fade-up" data-aos-delay="200">
              <img src="assets/img/makanan.png" class="img-fluid" alt="">
              <h3>Catering</h3>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              <img src="assets/img/rumah.png" class="img-fluid" alt="">
              <h3>Sewa kost-kostn</h3>
              <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-primary" type="button">Sewa</button>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="600">
              <img src="assets/img/motor.png" class="img-fluid" alt="">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <div>
                <p>Programmer (Frontend/ Backend)</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              <i class="bi bi-people" style="color: #bb0852;"></i>
              <div>
                <p>Content Creative /Desainer Grafis</p>
              </div>
            </div>
          </div>
